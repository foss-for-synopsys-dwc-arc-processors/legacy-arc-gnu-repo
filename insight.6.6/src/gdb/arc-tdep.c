                                        ...
                                        struct frame_info* next_frame)
{
    ...
    if (info->uses_fp)
    {
         ...
         */
        frame_unwind_unsigned_register(next_frame, ARC_FP_REGNUM, &this_base);
    ...
    else
    {
         ...
         * from the next frame.
         */
        frame_unwind_unsigned_register (next_frame, ARC_SP_REGNUM, &this_sp);
                    ...
                    void             **this_prologue_cache)
{
    ...
    {
        CORE_ADDR    entrypoint = frame_func_unwind(next_frame);
                         ...
                         struct reggroup *group)
{
    ...
    if (group == save_reggroup || group == restore_reggroup)
    {
        ...
        return (arc_cannot_store_register(regnum) ? 0 : 1);
    }
                ...
                else
                {
                    ...
                    for (r = 0; r < numregs; r++)
                    {
                            ...
                            gdbarch_register_reggroup_p (current_gdbarch, r, all_reggroup))
                        {
                            ...
                            {
                                (void) sprintf(line + 38, "saved register '%s'", REGISTER_NAME(r));
                                print = TRUE;
                                break;
                            }
                        }
