...
RBCR ( CRC_BASE_BUILD,       0x62,  "BCRBCR for CRC Unit",                               ARC_BCR_2_REGNUM,                0xFFFFFFFF,   RO,   ARCompact )
RBCR ( BTA_LINK_BUILD,       0x63,  "Interrupt Link Registers Available for BTA",        ARC_BCR_3_REGNUM,                0xFFFFFFFF,   RO,   ARCompact )
RBCR ( DVBF_BUILD,           0x64,  "BCRBCR for Dual Viterbi Instruction",               ARC_BCR_4_REGNUM,                0xFFFFFFFF,   RO,   ARCompact )
RBCR ( TEL_INSTR_BUILD,      0x65,  "BCRBCR for Extended Arithmetic Instructions",       ARC_BCR_5_REGNUM,                0xFFFFFFFF,   RO,   ARCompact )
RBCR ( MEMSUBSYS,            0x67,  "BCRBCR for Memory Subsystem",                       ARC_BCR_7_REGNUM,                0xFFFFFFFF,   RO,   ARCompact )
RBCR ( VECBASE_AC_BUILD,     0x68,  "BCRBCR for Interrupt Vector Base",                  ARC_BCR_8_REGNUM,                0xFFFFFFFF,   RO,   ARCompact ) 
...
RBCR ( DCCM_BUILD,           0x74,  "BCRBCR for DCCM (Data Closely Coupled Memory)",     ARC_BCR_14_REGNUM,               0xFFFFFFFF,   RO,   ARCompact )
RBCR ( TIMER_BUILD,          0x75,  "BCRBCR for Timers",                                 ARC_BCR_15_REGNUM,               0xFFFFFFFF,   RO,   ARCompact )
...
RBCR ( ICCM_BUILD,           0x78,  "ICCM BCRBCR (Instruction Closely Coupled Memory)",  ARC_BCR_18_REGNUM,               0xFFFFFFFF,   RO,   ARCompact )
