...
#ifndef ARC_AUX_REGISTERS_H
#define ARC_AUX_REGISTERS_H
...
#define AUX_REG_DEFINITION_FILE    "arc-aux-registers.xml"
...
/* bit masks for use with the auxiliary DEBUG, IDENTITY, STATUS32 and AP_BUILD
 * registers
 */
