	  ...
	  if (!mach_a4 && ((unsigned int) reg->value > 63))
	    {
	      ...
	      *errmsg = buf;
          ...
          if (!mach_a4 && (   ('B' == operand->fmt) || ('#' == operand->fmt)
...
int
ac_branch_or_jump_insn(arc_insn insn)
{
...
get_ext_suffix (char *s, char field)
{
  ...
  switch(field){
  case 'e' : 
      ctype = mach_a4 ? CACHEBYPASS5 : 0;
      break;
  case 'f' : 
      ctype = mach_a4 ? FLAG : FLAG_AC;
      break;
  case 'j' : 
      ctype = mach_a4 ? JUMPFLAGS : 0;
      break;
  case 'p' : 
      ctype = mach_a4 ? 0 : ADDRESS9_AC;
      break;
  case 'q' : 
      ctype = mach_a4 ? COND : COND_AC;
      break;
  case 't' : 
      ctype = mach_a4 ? 0 : SIZE7_AC;
      break;
  case 'v' : 
      ctype = mach_a4 ? ADDRESS24 : CACHEBYPASS11_AC;
      break;
  case 'w' : 
      ctype = mach_a4 ? ADDRESS3 : ADDRESS3_AC;
      break;
  case 'x' : 
      ctype = mach_a4 ? SIGN0 : SIGN6_AC;
      break;
  case 'y' : 
      ctype = mach_a4 ? SIZE22 : 0;
      break;
  case 'z' : 
      ctype = mach_a4 ? SIZE1 : SIZE1_AC;
      break;
  case 'D' : 
      ctype = mach_a4 ? CACHEBYPASS26 : CACHEBYPASS5_AC;
      break;
  case 'E' : 
      ctype = mach_a4 ? CACHEBYPASS14 : 0;
      break;
  case 'P' : 
      ctype = mach_a4 ? 0 : ADDRESS22_AC;
      break;
  case 'T' : 
      ctype = mach_a4 ? 0 : SIZE17_AC;
      break;
  case 'V' : 
      ctype = mach_a4 ? 0 : CACHEBYPASS15_AC;
      break;
  case 'W' : 
      ctype = mach_a4 ? ADDRESS12 : 0;
      break;
  case 'X' : 
      ctype = mach_a4 ? SIGN9 : SIGN16_AC;
      break;
  case 'Z' : 
      ctype = mach_a4 ? SIZE10 : 0;
      break;
  case '&' : 
      ctype = mach_a4 ? 0 : ADDRESS22S_AC;
      break;
  default : 
      ctype = mach_a4 ? COND : COND_AC;
      break;
